...
const Footer = () => {
  return (
    <>
      {/* <NewsletterSection /> */}
      <div className="w-full bg-[#151a30]" data-keywords="indusynergypartners indusynergy indus">
        <footer className="relative z-10" data-keywords="indusynergypartners indusynergy indus">
          <div className="pt-[100px] pb-[90px] md:py-[90px] md:pb-[20px] overflow-hidden relative -z-10 px-[10px] md:px-8" data-keywords="indusynergypartners indusynergy indus">
            <div className="max-w-[1500px] mx-auto" data-keywords="indusynergypartners indusynergy indus"> 
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8" data-keywords="indusynergypartners indusynergy indus">
                
                {/* Logo & Intro */}
                <div className="text-left" data-keywords="indusynergypartners indusynergy indus">
                  <div className="mb-7" data-keywords="indusynergypartners indusynergy indus">
                    <Link to="/" className="text-[45px] font-bold flex items-center text-white" data-keywords="indusynergypartners indusynergy indus">
                      <img
                        src={Indussynergylogo}
                        alt="IndUS Synergy Logo indusynergypartners indusynergy indusindusynergypartners indusynergy indusindusynergypartners indusynergy indus indusynergypartners indusynergy indus indusynergypartners indusynergy indus"
                        className="w-[16rem]  rounded-sm object-cover"
                      />
                    </Link>
                  </div>
                  <p className="text-white text-[16px] mb-[10px]" data-keywords="indusynergypartners indusynergy indus">
                  ...
                  {/* Social Media Icons */}
                  <ul className="overflow-hidden pt-[15px] flex space-x-[15px]" data-keywords="indusynergypartners indusynergy indus">
                    {[
                ...
                <div className="text-left" data-keywords="indusynergypartners indusynergy indus">
                  ...
                  <ul data-keywords="indusynergypartners indusynergy indus">
                    {['Home', 'About Us', 'Blogs', 'Contact'].map((label, idx) => {
                      const path = ['/', '/about', '/blog', '/contact'][idx];
                      return (
                        <li key={idx} className="mb-[8px]" data-keywords="indusynergypartners indusynergy indus">
...
<div className="text-left" data-keywords="indusynergypartners indusynergy indus">
  ...
  <ul className="text-white" data-keywords="indusynergypartners indusynergy indus">
    ...
    <li className="mb-[8px]">
      Email: <a href="mailto:indusynergypartners@gmail.com" className="text-white underline hover:text-[#c0b596]">indusynergypartners@gmail.com</a>
          ...
          {/* Bottom Bar */}
          <div className="px-[10px] md:px-8" data-keywords="indusynergypartners indusynergy indus">
            <div className="max-w-[1500px] mx-auto border-t border-[rgba(192,181,150,.3)] relative" data-keywords="indusynergypartners indusynergy indus">
